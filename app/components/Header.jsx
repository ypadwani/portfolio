...
const Header = () => {
  return (
    ...
    <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
        ...
        href="#contact" className='px-10 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2 dark:bg-transparent'>Contact Me <Image src={assets.right_arrow_white} alt='' className='w-4'></Image>
        </motion.a>
