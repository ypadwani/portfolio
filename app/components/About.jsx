...
const About = ({isDarkMode}) => {
  return (
    ...
    id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='flex w-fulll flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2x1'>
            {infoList.map(({icon, iconDark, title, description}, index)=>(
                ...
                className='border-[0.5px] border-gray-400 rounded-x1 p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50' key={index}>
        ...
        className='flex items-center gp-3 sm:gap-5'>
